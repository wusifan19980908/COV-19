...
public class DateUtil {
    ...
    /** 时间格式(yyyy年MM月dd日)*/
    public final static String DATE_PATTREN_UNIT = "yyyy年MM月dd日";
    /**
    ...
    public static String formatDateUnit(Date date){return format(date,DATE_PATTREN_UNIT);}
    /**
     * 日期格式化 日期格式为：yyyy-MM-dd
     * @param date  日期
    ...
    public static Date getCurrentMonthLastDay(Date date){
        Calendar calendar = Calendar.getInstance();// 设置为1号,当前日期既为本月第一天
        calendar.setTime(date);
